...
#  checkOK
	...
	cordova plugin add cordova-plugin-customurlscheme --variable URL_SCHEME=intervalue-tn
	checkOK
...
#	checkOK
	...
	cordova plugin add https://github.com/intervalue-hashnet/cordova-sqlite-plugin.git
	checkOK
